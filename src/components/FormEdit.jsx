...
import { useAddFileMutation, useGetFilesQuery, useUpdateFileMutation } from '../store/apis/fileApi/';
import { useGetAdditionalInformationFileQuery, useUpdateAditionaInformationFileMutation } from '../store/apis/additionalInformationFileApi/';
...
const FormEdit = () => {
  ...
  const [editInformation] = useUpdateAditionaInformationFileMutation();
  const { data: initialValues, isLoading } = useGetFilesQuery(id);
  const { data: editar, isLoading: isLoadingEditar } = useGetAdditionalInformationFileQuery(id);
  console.log(editar);
  ...
  formik.initialValues.date = dataEdit?.date || "";
